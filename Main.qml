...
ApplicationWindow {
    ...
    ListModel {
        id: tabsModel
        ListElement { title: "Google"; address: "https://www.google.com"; icon: "" }
    }
    ...
    ColumnLayout {
        ...
        TabBar {
            ...
            Repeater {
                ...
                TabButton {
                    ...
                    Button {
                        ...
                        height: 24
                        onClicked: {
                            if (tabsModel.count > 1) tabsModel.remove(index)
                                else Qt.quit()
                        }
            ...
            TabButton {
                ...
                width: 46
                onClicked: {
                    tabsModel.append({ title: "New Tab", address: "https://www.google.com" })
